      ...
      >
        ...
        <div className="relative lg:w-[58%] aspect-[16/9] lg:aspect-auto overflow-hidden flex-shrink-0">
          ...
          <div
            ...
            style={{ background: "linear-gradient(to right, transparent 60%, rgba(8,8,8,0.5) 100%)" }}
            aria-hidden="true"
          />
        </div>
        ...
        <div className="flex flex-col justify-center p-8 lg:p-12 gap-5">
          ...
          <div className="flex items-center gap-3 mt-auto pt-4 border-t border-white/5">
            <span className="font-mono text-xs text-gray-muted">{formatDate(post.publishedAt)}</span>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col flex-1 p-6 gap-3">
        <Badge variant="category">{post.category.title}</Badge>
